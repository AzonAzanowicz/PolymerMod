...
public abstract class _BlockComplex extends _BlockBase {
    ...
    public _BlockComplex(String name, Properties properties) {
        super(name, properties);
        checkTalents();
    }

    public _BlockComplex(String name, DyeColor color, Properties properties) {
        super(name+"_"+color.getTranslationKey(), properties);
        this.color=color;
    }
